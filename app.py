...
if "historico" not in st.session_state:
    st.session_state.historico = []   # lista de dicts com resultados salvos
...
if file_vagas and file_colab:
    ...
    if st.button("🚀 Buscar Vagas Compatíveis"):
        ...
        entrada_historico = {
            ...
            "vagas":        len(resultado),
            "resultado":    resultado,
            "colunas":      None,   # preenchido abaixo após montar colunas_exibir
            "cv_usado":     bool(texto_cv.strip()),
        }

        # Atualiza ou adiciona no histórico (mantém apenas a última análise por colaborador)
